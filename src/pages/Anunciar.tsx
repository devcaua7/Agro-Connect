/**
 * ANUNCIAR PAGE — Formulário para criar um anúncio (com persistência no banco)
 * 
 * EXPLICAÇÃO:
 * - useState gerencia cada campo do formulário individualmente.
 * - Ao submeter, os dados são enviados ao Supabase via INSERT.
 * - Se o usuário enviar uma foto, ela é salva no Supabase Storage.
 * - useQueryClient().invalidateQueries invalida o cache para atualizar a Home.
 * - Redireciona para Home após sucesso com navigate("/").
 */
...
const Anunciar = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // Invalida o cache para atualizar a lista de produtos
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div
              ...
              className="border-2 border-dashed border-border rounded-xl p-8 flex flex-col items-center
